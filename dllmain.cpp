...
void Patches() {
    ...
    // from skip_sel_result.p credit to somewhatlurker
    InjectCode((void*)0x1405d6b04, { 0x41, 0xc7, 0x46, 0x68, 0x14, 0x00, 0x00, 0x00 }); // MOV dword ptr [R14 + 0x68],0x14
    InjectCode((void*)0x1405d6b0c, { 0x90, 0x90, 0x90, 0x90, 0x90 });
